...
class TestCorrelationIdMiddleware:
    def test_generates_correlation_id(self):
        ...
        from webgui.app import CorrelationIdMiddleware
    ...
    def test_propagates_existing_correlation_id(self):
        ...
        client = TestClient(test_app)
        response = client.get("/test", headers={"X-Correlation-ID": "my-id-123"})
...
class TestSecurityHeadersMiddleware:
    def test_adds_security_headers(self):
        ...
        from webgui.app import SecurityHeadersMiddleware
